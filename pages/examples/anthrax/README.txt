...
- FHIRv102: CQL code for version of artifact that uses a FHIR DSTU2 (v1.0.2) data model.
- FHIRv300: CQL code for version of artifact that uses a FHIR STU3 (v3.0.0) data model.
- FHIRv400: CQL code for version of artifact that uses a FHIR R4 (v4.0.0) data model.
...
subdirectories:
- FHIRv102: Example DetectedIssue alerts in FHIR DSTU2 (v1.0.2) format.
- FHIRv300: Example DetectedIssue alerts in FHIR STU3 (v3.0.0) format.
- FHIRv400: Example DetectedIssue alerts in FHIR R4 (v4.0.0) format.
...
- FHIRv102: Device resource in FHIR DSTU2 (v1.0.2) format.
- FHIRv300: Device resource in FHIR STU3 (v3.0.0) format.
- FHIRv400: Device resource in FHIR R4 (v4.0.0) format.
...
subdirectories:
- FHIRv102: Example Flag alerts in FHIR DSTU2 (v1.0.2) format.
- FHIRv300: Example Flag alerts in FHIR STU3 (v3.0.0) format.
- FHIRv400: Example Flag alerts in FHIR R4 (v4.0.0) format.
...
- FHIRv102: Library resources in FHIR DSTU2 (v1.0.2) format.
- FHIRv300: Library resources in FHIR STU3 (v3.0.0) format.
- FHIRv400: Library resources in FHIR R4 (v4.0.0) format.
...
- http://build.fhir.org/ig/HL7/cqf-recommendations/cdc-library.html
...
- FHIRv102: Example PlanDefinition resources in FHIR DSTU2 (v1.0.2) format.
- FHIRv300: Example PlanDefinition resources in FHIR STU3 (v3.0.0) format.
- FHIRv400: Example PlanDefinition resources in FHIR R4 (v4.0.0) format.

Each subdirectory should contain the FHIR resources in JSON format, as well as a text
file that captures the results from validating said resources using the
[FHIR Validator](http://wiki.hl7.org/index.php?title=Using_the_FHIR_Validator). Where
appropriate, the resources are also validated against the profiles available at:
- http://build.fhir.org/ig/HL7/cqf-recommendations/cdc-plandefinition.html
- http://build.fhir.org/ig/HL7/cqf-recommendations/cdc-activitydefinition.html
