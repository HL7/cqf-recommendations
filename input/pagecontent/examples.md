...
*   [CHF Example Codes](CodeSystem-chf-example-codes.html)

    Codes used in the congestive heart failure pathway example. Ideally these shouldn't exist, but where an appropriate code in a standard terminology could not be identified, codes are defined in this example code system.
