ValueSet: CPGRecommendationDirectionVS
Id: cpg-recommendation-direction-vs
...
* insert ValueSetMetadata(cpg-recommendation-direction-vs)
* include codes from system CPGRecommendationDirectionCS