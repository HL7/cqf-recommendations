ValueSet: CPG_Recommendation_Direction
...
* insert ValueSetMetadata(cpg-recommendation-direction, ValueSet)
* include codes from system $cpg-recommendation-direction