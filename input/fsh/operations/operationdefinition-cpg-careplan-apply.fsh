...
* parameter[+]
  ...
  * min = 1
  * max = "1"
  * documentation = "The CarePlan that is the result of applying the optional aspects of the input CarePlan"
  * type = #CarePlan